...
const Alquileresfecha = (props) => {
  ...
  return (
    <>
      {!alquileres.length > 0 ? null : (
        <>
          <div className="contenedor-alquileres-fecha">
            <section>
              <h3>Lista de alquileres del vehículo con placa {props.placa}</h3>
              <p className="titulo-titulo">
                Estas son las fechas en las que este vehiculo con placa{" "}
                <strong>{props.placa}</strong>, está ocupada.
                <br />
                Revisa y no alquiles el vehiculo en esas fechas para no cruzarte
                con otros alquileres.
              </p>
            </section>
          </div>
