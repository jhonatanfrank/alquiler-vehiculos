                  ...
                  <table className="table table-bordered">
                        ...
                        <div>
                          <h5>
                            <svg
                              ...
                              height="25"
                              fill="black"
                              class="bi bi-car-front-fill mr-2"
                              viewBox="0 0 16 16"
                            >
                          ...
                          <div>
                            <h5>
                              <svg
                                ...
                                height="25"
                                fill="black"
                                class="bi bi-fuel-pump-diesel-fill mr-2"
                                viewBox="0 0 16 16"
                              >
                        ...
                        <div>
                          <h5>
                            <svg
                              ...
                              height="25"
                              fill="black"
                              class="bi bi-currency-exchange mr-2"
                              viewBox="0 0 16 16"
                            >
                    ...
                    <tr>
                      <td>
                        <div>
                          <h5>
                            Se encontraron: {filteredVehiculos.length} vehículos
                          </h5>
                        </div>
                      </td>
                    </tr>
